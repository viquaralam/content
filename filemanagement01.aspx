...
<!-- Begin Drop Down Table of Contents Menu -->
				...
				<div class="row">
					...
					<div class="sectionContent">
						...
						<div class="row">
							<div class="twelve columns">
							<a name="content"></a><h4>Getting to the C: Drive</h4>										
						...
						<hr>
							...
							<img class="left" src="images/filesandfolders/computer.jpg" alt="">
							<p><strong>Desktop Icon for Computer</strong></p><hr />	
							<img class="left" src="images/filesandfolders/mycomputer.jpg" alt="">
							<p><strong>Desktop Icon for My Computer</strong></p><hr />	
                                <img class="left" src="images/filesandfolders/thispc.jpg" alt="">
							<p><strong>Desktop Icon for This PC</strong></p><hr />
                                <p>In the directory you will see an icon for each of the drives on your computer, including the C: drive.</p>	
							<hr /><p>In some versions of Windows, you can also access <strong>My Computer</strong> or <strong>Computer</strong> by clicking on the Start button. From the pop-up menu that you see, select <strong>Computer</strong> or <strong>My Computer</strong>.</p>
							<hr>
