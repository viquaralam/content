...
(function($){
	...
	var defaults = {
		...
		startText : '',
		endText: '',
		splashImage: '../images/quiz/start.png',
    ...
    for (questionsIteratorIndex = 0; questionsIteratorIndex < config.questions.length; questionsIteratorIndex++) {
        ...
        if (questionsIteratorIndex !== 0) {
            contentFob += '<div class="prev"><a class="nav-previous" href="#">Previous Question</a></div>';
        }

        if (questionsIteratorIndex < config.questions.length - 1) {
            contentFob += '<div class="next"><a class="nav-next" href="#">Next Question</a></div>';
        }
 else {
