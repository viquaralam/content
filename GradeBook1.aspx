            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <asp:FormView ID="FormView1" runat="server" DataSourceID="SqlDataSource2" 
                        DataKeyNames="UserQuizId" Width="575px" DefaultMode="ReadOnly">
                        <EditItemTemplate>
                            Checklist:
                            <asp:Label ID="ChecklistLabel1" runat="server" 
                                Text='<%# Eval("UserQuizId") %>' />
                            <br />
                            Task Type:
                            ...
                            <asp:TextBox ID="UserQuizId" runat="server" 
                                Text='<%# Bind("UserQuizId") %>' Visible="false" />
                            <br />
                        ...
                        <InsertItemTemplate>
                            ...
                            <br />
                            UserQuizId:
                            <asp:TextBox ID="UserQuizIdTextBox" runat="server" 
                                Text='<%# Bind("UserQuizId") %>' />
                            <br />
                            Tasky0:
