<%@ Page Language="VB" MasterPageFile="~/MasterPage1.master" AutoEventWireup="false" CodeFile="InternetResults2.aspx.vb" Inherits="TestingCenter_Internet_FinalResults2" title="DIDL Essential License Internet Final Test" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br /><br />
<table class="container" align="center">
        <tr>
            <td style="width: 600px; vertical-align: middle; color: white; background-color: #00aeef; text-align: left;" class="pageHeader questionHeader"><h4>When you are finished viewing the</h4><h4>question below close the window.</h4>
            </td>
        </tr>
        <tr>
        <td align="center">
