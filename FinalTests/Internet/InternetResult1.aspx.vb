    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Ptr = 0 Then
            ...
            If IsPostBack = False Then
                ...
                SqlCommand.Connection = usersInfoConnection
                SqlCommand.CommandText = "UPDATE Users SET TimesInternet = ISNULL(TimesInternet, 0) + 1,  TestInternet = (CASE WHEN @Score > 90  THEN GETDATE() ELSE TestInternet END) WHERE UserName =  @UserName"
