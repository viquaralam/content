					...
					<div class="twelve columns">
						...
						<div class="row">
							<div class="seven columns">
								...
								<hr>
								<a name="content"></a><p class="lead">In this section, you will learn the basic terms and concepts that explain how your computer works and what you see when you start it up. </p>
...
<h5>Getting Started</h5>
								...
								<a class="sublime zoomable" href="video/computerbasics.mp4">
								  <img src="img/video-cover/getstarted-vcover.jpg" alt="Computer Basics Video" width="241" height="147" data-autoresize='fit'/>
								  <span class="zoom_icon"></span>
								</a>
								<video style="display:none" width="649" height="480" poster="img/video-cover/getstarted-vid-nobar.jpg" data-title="CB Getting Started" data-uid="computerbasics" preload="none" data-autoresize='fit'>
									  <source src="video/computerbasics.mp4" />
									  								</video>
