				...
				<div class="row">
					...
					<div class="sectionContent">
						...
						<div class="row">
							...
							<p class="lead">Now that you know how to move, copy and delete an individual file or folder, there may be times when you want to move, copy or delete more than one at a time.</p>
...
<p>2. Next, click on the last file or folder that you want.</p>
				...
				<p>In the example below, the first file was "error.docx" and the last file was "didlbook.pdf". </p>
								...
								<img class="space" src="images/filesandfolders/consecutive.jpg"/>
...
<p>Below, the user has selected 4 non-consecutive files. Each one is highlighted in blue. Now, the group of 4 files can be moved, copied or deleted.</p>
					...
					<img class="space" src="images/filesandfolders/nonconsecutive.jpg"/>
...
<div>	
									...
									<div class="row">
										<div class="twelve columns">	
											...
											<video class="sublime" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="Selectingmultiplefilesorfolders" data-uid="def1f3df" preload="none">
