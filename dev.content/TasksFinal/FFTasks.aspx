<%@ Page Language="VB" MasterPageFile="~/MasterPage1.master" AutoEventWireup="false" CodeFile="FFTasks.aspx.vb"
    Inherits="TestingCenter_FinalTests_FMTasks" Title="File Management Task" %>
            ...
            <table style="width: 933px; height: 526px; border-bottom: gray thin solid; border="4"
                ...
                <tr>
                    <td colspan="3" class="pageHeader questionHeader">
                        <h2>Files and Folders <br />Task</h2>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" 
                        style="height: 32px; font-size: 16pt; font-weight: bold; font-style: italic;">
                        This window will be open for 30 minutes only!</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="width: 250px; height: 85px; vertical-align: top; text-align: justify;">
                        <span style="font-weight: bold;">Step 1.&nbsp; </span>Click on <strong>DOWNLOAD TASK</strong> to get the instructions for this task. You must complete <strong>THESE INSTRUCTIONS</strong> and upload the files called for by <strong>THESE INSTRUCTIONS</strong> within the 30 minute time limit.
...
<br />
                    ...
                    <td style="height: 85px; text-align: left;" colspan="3">
                        <asp:HyperLink ID="TaskLink1" runat="server" NavigateUrl="~/FinalTests/Tasks/FM/didlFMTask1.pdf"
                            Target="_blank" Height="16px" Width="173px" Font-Bold="True" 
                            Font-Size="14pt">DOWNLOAD TASK</asp:HyperLink>
...
<span style="font-weight: bold; vertical-align: middle;">Step 4.&nbsp;</span> Click the Finish button at the top of the page.
                    ...
                    <td style="vertical-align: top; height: 202px; text-align: center" 
                        align="left" colspan="3">
                        <fieldset style="width: 584px">
                            <table style="width: 99%; height: 232px;">
                                <tr>
                                    <td style="width: 573px; height: 214px">
                                        <strong>Select the files first by clicking on the Browse Button and then click Upload File.<br />
