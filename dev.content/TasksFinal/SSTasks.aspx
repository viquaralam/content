<%@ Page Language="VB" MasterPageFile="~/MasterPage1.master" AutoEventWireup="false" CodeFile="SSTasks.aspx.vb" Inherits="TestingCenter_FinalTests_SSTasks" title="SpreadSheet Tasks" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" />
        ...
        <div class="row" style="width: 641px; height: 1065px;">
            ...
            <table style="width: 600px; height: 526px; border-bottom: gray thin solid;" border="4"
                ...
                <tr>
                    <td style="width: 238px; height: 85px; vertical-align: middle; text-align: justify;">
...
<br />
                    ...
                    <td style="vertical-align: top; "height: 85px; text-align: left;" colspan="2">
...
When you click on <strong>DOWNLOAD TASK</strong>, another window will appear the instructions. Print the instructions from that window and close it. <br /><br /><strong>OR</strong> <br /><br /> If you can not print, you can size the window, move it to the side for reference during the task, or you can keep referring to the instructions by clicking on the tab for the instructions in the browser. 
                ...
                <tr>
                    <td style="vertical-align: top; width: 238px; height: 202px; text-align: justify">
...
<span style="font-weight: bold; vertical-align: middle;">Step 4.&nbsp;</span> Click the Finish button at the top of the page.
                    ...
                    <td style="vertical-align: middle; height: 202px; text-align: left" 
