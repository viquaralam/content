<%@ Page Language="VB" MasterPageFile="~/MasterPage1.master" AutoEventWireup="false" CodeFile="WPTasks.aspx.vb" Inherits="TestingCenter_FinalTests_WPTasks" title="Word Processing Tasks" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" />
    ...
    <table style="width: 933px; height: 526px; border-bottom: gray thin solid;" border="4" cellpadding="5">
        <tr>
            <td  colspan="3" class="pageHeader questionHeader">
                <h2>Word Processing <br />Task</h2></td>
        </tr>
        <tr>
            <td colspan="4" 
                        style="height: 32px; font-size: 16pt; font-weight: bold; font-style: italic;">
                The window will be closed in 30 minutes!</td>
        </tr>
        <tr>
            ...
            <ContentTemplate>Start Date/Time:<br /><asp:Label ID="Label1" runat="server" Width="281px" Text="label" Height="18px" />
            </ContentTemplate>
            </asp:UpdatePanel>
                </td>
            ...
            <ContentTemplate>
                End Date/Time:<br /><asp:Label ID="Label2" runat="server" Text="Label2" Width="281px" Height="18px" />
               </ContentTemplate>
    </asp:UpdatePanel>
            </td>
           <td style="height: 32px; vertical-align: top; text-align: center; width: 324px;">
                        <asp:Button ID="ExitBtn1" runat="server" Text="Finish" CssClass="nice red button" OnClick="ExitBtn1_Click"/>
                    </td>
        </tr>
        <tr>
            <td style="width: 250px; height: 85px; vertical-align:middle; text-align:justify;"><span style=" font-weight:bold; ">
               Step 1.&nbsp; </span>Click on <strong>DOWNLOAD TASK</strong> to get the instructions for this task. You must complete <strong>THESE INSTRUCTIONS</strong> and upload the files called for by <strong>THESE INSTRUCTIONS</strong> within the 30 minute time limit.
<br />
<br />
<br />
<br />
...
Follow the instructions you just downloaded. You will have to <strong>minimize this browser window</strong> during the task so you can complete the task. 
...
<br />
            ...
            <asp:HyperLink ID="TaskLink1" runat="server" 
                    NavigateUrl="~/FinalTests/Tasks/FM/didlFMTask1.pdf" 
                    Target="_blank" Height="16px" Width="173px" Font-Bold="True" Font-Size="14pt">DOWNLOAD Task</asp:HyperLink>

<br /><br />
When you click on <strong>DOWNLOAD TASK</strong>, another window will appear the instructions. Print the instructions from that window and close it. <br /><br /><strong>OR</strong> <br /><br /> If you can not print, you can size the window, move it to the side for reference during the task, or you can keep referring to the instructions by clicking on the tab for the instructions in the browser. 
        ...
        <tr>
            <td colspan="1" 
                style="vertical-align: top; width: 410px; height: 202px; text-align: justify">
...
<span style="font-weight: bold; vertical-align: middle;">Step 4.&nbsp;</span> Click the Finish button at the top of the page.
            ...
            <tr>
                <td style="width: 573px; height: 214px">
                        ...
                        </strong>Repeat this step until all files are uploaded.  Each file upload may take 1 to 2 minutes to complete, please be patient.
                        <br />
                        
			<asp:FileUpload ID="myFileUpload" runat="server" Width="410px" />
			<asp:Button ID="btnFileUpload" runat="server"	Text="Upload File"	OnClick="btnFileUpload_Click" Height="21px" />

			<hr style="width: 618px" />

			<p>Received the following file:</p>
			<table border="1">
				<tr>
					<td align="right"><strong>File Name:</strong></td>
					<td><asp:Label ID="lblFileName" runat="server" Width="380px" /></td>
				</tr>
				<tr>
					<td align="right"><strong>File Type:</strong></td>
					<td><asp:Label ID="lblFileType" runat="server" /></td>
				</tr>
				<tr>
