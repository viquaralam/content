...
<!--! end of Section Header -->
				...
				<div class="row">
					...
					<div class="sectionContent">
						...
						<div class="row">
							<div class="twelve columns">
								<h4>Searching for Files or Folders</h4>
							...
							<p class="lead">When you are looking for a file or folder on your computer and you cannot find it, you use search to look for it. <p>
								...
								<p>Search is easy! All you do is find the <strong>search box</strong> (usually represented with a magnifying glass icon), type the name of the file or folder you want to find, and hit enter. <img class="right" src="images/filesandfolders/searchicon.jpg"/></p>
...
<img class="full-width" src="images/filesandfolders/win7search.jpg"/>																
...
<img class="img-wrap style1" src="images/filesandfolders/win7search2.jpg"/>
...
<h4>What do you do if you don't find the file?</h4>										
 <p>If you do not find the file, you need to make sure you have set up the search correctly. To do this, you need to know about <strong>Advanced Search Settings.</strong><p>								<p>For the DIDL, you may be asked to search for a file that has a file extension of .exe, .dll, .dat, etc. These file extensions are system file extensions and are typically located in system folders, which are not usually included in the search. If your search <strong>does not find the file</strong>, you will need to change the Search Options and try again.</p>
			...
			<img class="full-width" src="images/filesandfolders/win7search3.jpg"/>					
...
<img class="full-width" src="images/filesandfolders/folderoptionssearch.jpg"/>									
								<hr>
...
<p>The picture below shows where to find Computer in the "Search again in" options.</p>
								...
								<img class="full-width" src="images/filesandfolders/win7search4.jpg"/>
<hr>												
...
<h4>What do you do if you find the file but cannot see the folders from the window?</h4>
								...
								<img class="full-width" src="images/filesandfolders/win7search5.jpg"/>
<hr>
<h4>Sizing the Field so You Can See All of the Folders</h4>							
					<p>Once you have selected Details View, you still may not be able to see all of the folders until you Size the Folder's field. The arrow in the picture below shows where to place mouse pointer to size the Folder's field.</p>
										<img class="full-width" src="images/filesandfolders/win7search6.jpg"/>						
...
<p> Also notice that Windows puts the folder the file is in first and then in parenthesis puts the other folders in the path.</p>							<img class="full-width" src="images/filesandfolders/win7search7.jpg"/>
...
<hr>
	...
	<div class="row">
					<div class="twelve columns">	
						...
						<br>
					<div>	
						<video class="sublime" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="Findingaspecificfilewin7" data-uid="def1f3df" preload="none">
...
<img class="full-width" src="images/filesandfolders/vistasearch2.jpg"/>
...
<p>If you do not find the file, you need to make sure you have set up the search correctly. To do this, you need to know about <strong>Advanced Search Settings.</strong><p>								<p>For the DIDL, you may be asked to search for a file that has a file extension of .exe, .dll, .dat, etc. These file extensions are system file extensions and are typically located in system folders, which are not usually included in the search. If your search <strong>does not find the file</strong>, you will need to change the Search Options and try again.</p>
			...
			<img class="full-width" src="images/filesandfolders/vistasearch3.jpg"/>					
...
<p>The picture below shows Advanced Search. Notice Indexed Locations is selected under Location and you can type the name of the file you wish to find in the Name box and click on Search.</p>
								...
								<img class="full-width" src="images/filesandfolders/vistasearch4.jpg"/>
<hr>								<h4>What do you do if you find the file but cannot see the folders from the window?</h4>							
								...
								<img class="full-width" src="images/filesandfolders/vistasearch5.jpg"/>
<hr>
<h4>Sizing the Field so that You Can See All of the Folders</h4>							
					<p>Once you have selected Details View, you still may not be able to see all of the folders until you Size the Folder's field. The arrow in the picture below shows where to place mouse pointer to size the Folder's field.</p>
										<img class="full-width" src="images/filesandfolders/vistasearch6.jpg"/>						
				
<hr>				<p>All of the folders are now seen in the picture below after sizing the Folder's field. </p>
								
						
<p> Also notice that Windows puts the folder the file is in first and then in parenthesis puts the other folders in the path.</p>							<img class="full-width" src="images/filesandfolders/vistasearch7.jpg"/>
...
<img class="full-width" src="images/filesandfolders/vistasearch8.jpg"/>
...
<hr>
					...
					<div class="twelve columns">	
						...
						<br>
					<div>	
						<video class="sublime" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="Findingaspecificfilevista" data-uid="def1f3df" preload="none">
...
<img class="full-width" src="images/filesandfolders/classicsearch.jpg"/>							
							<hr>
	...
	<img class="full-width" src="images/filesandfolders/classicsearch2.jpg"/>						
								<hr>
		...
		<img class="full-width" src="images/filesandfolders/classicsearch3.jpg"/>						<hr>
...
<img class="full-width" src="images/filesandfolders/classicsearch4.jpg"/>						<hr>
...
<img class="full-width" src="images/filesandfolders/classicsearch5.jpg"/>						<hr>
...
<p>Once you have selected Details View, you still may not be able to see all of the folders until you Size the Folder's field. The arrow in the picture below shows where to place mouse pointer to size the Folder's field.</p>
										<img class="full-width" src="images/filesandfolders/classicsearch6.jpg"/>						
				
<hr>				<p>All of the folders are now seen in the picture below after sizing the Folder's field. </p>
								
						
							<img class="full-width" src="images/filesandfolders/classicsearch7.jpg"/>
...
<img class="full-width" src="images/filesandfolders/classicsearch8.jpg"/>
...
<div class="row">
					...
					<div>
						...
						<video class="sublime" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="Findingaspecificfileclassic" data-uid="def1f3df" preload="none">
