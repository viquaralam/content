...
<!-- Begin Drop Down Table of Contents Menu -->
				...
				<div class="row">
					...
					<div class="sectionContent">
						<div class="row">
							<div class="twelve columns">																		
								<p class="lead">As you learned in Desktops and Icons, what you see on your screen after the computer boots up is called the desktop. One way to open programs on your computer is to double click on the icons that you see on the desktop.</p>
...
<p>When you open a program, it opens into what is called a window and you will see the program name listed in the taskbar at the bottom of your screen. Let's learn more about these windows - what you see in them and how to manage them.</p>
																
						<p>A <strong>window</strong> is a square portion on the screen surrounded by a border with a title bar at the top of it.</p>
								<p>The <strong>title bar</strong> is at the top of the window. It tells you the name of the program. If you open a document, spreadsheet, etc. it will also tell you the name of the document or if the document does not have a name yet, it will say, untitled.</p>
								...
								<img class="center" src="images/computerbasics/titlebar.png"/>

<hr>																<p>On the left side of the title bar in the above picture, you see that the open program is called Paint and that the document has no title yet, so it is untitled.</p>
...
<hr>
								...
								<h5>Window With Panes</h5>
															<img class="img-wrap style1" src="images/computerbasics/windowpanes.png" width="699" height="518"/>
								<br />
								<br />
...
<h5>Using the Buttons on the Title Bar</h5>
								...
								<img class="img-wrap style1" src="images/computerbasics/systembuttons.png"/>
							<br>
							<br>
							<div class="panel">
								<h5><em>Try It!</em></h5>
...
<video class="sublime" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="MaximizingAndMinimizing" data-uid="def1f3df" preload="none">
...
<p>Remember from the <strong>Desktop, Mouse, and Booting Up Section</strong>, the taskbar is the strip at the bottom of the screen. The middle of the taskbar is the section that shows you the tasks you have opened.</p>							<p>Three programs are opened and minimized on the taskbar in this example.</p>
								<img class="img-wrap style1" src="images/computerbasics/taskbar.png" width="699" height="225"/>
						...
						<div class="row">
							<div class="twelve columns">								
								...
								<br />
								<br />
								<img class="img-wrap style1" src="images/computerbasics/vistaaero.png" width="496" height="298"/>
								<br />
								<br />
								...
								<img class="img-wrap style1" src="images/computerbasics/vista-aero-icon.png"/>
								<hr>
...
<h4>Vista Aero Flip - Demo</h4>
								<br>
									...
									<div>	
										<video class="sublime" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="Vistaaeroflip" data-uid="def1f3df" preload="none">
...
<a name="ss3"></a>		
								...
								<p>You learned about click and drag in The Desktop, Mouse and Booting Up.</p>
								...
								<img class="img-wrap style1" src="images/computerbasics/MoveWindow.png" width="699" height="517"/>
						<br />		
						<br />		
...
<div class="row">
							<div class="twelve columns">	
								...
								<br>
									...
									<div>	
										<video class="sublime" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="Movingawindow" data-uid="def1f3df" preload="none">
...
<a name="ss4"></a>	
						...
						<img class="img-wrap style1" src="images/computerbasics/sizing-a-window.png" width="198" height="163"/>
...
<hr>							
							...
							<img class="img-wrap style1" src="images/computerbasics/PaneTooSmall.jpg" width="699" height="518"/>
						<hr>																				
									<p>In the picture below, the pane is sized to see the folder names. </p>
						
								<img class="img-wrap style1" src="images/computerbasics/PaneSized.jpg" width="699" height="518"/>	
						<hr>								
																				<p>Whenever you see a folder or file name with three dots after it (like Empowerment Mo... in the picture below), you must size the field in order to see the rest of the file name. A field is the space allowed for information.</p>


								<img class="img-wrap style1" src="images/computerbasics/FieldTooSmall.jpg" width="699" height="518"/>
						<hr>								
																				
								<p>Move the cursor or mouse pointer to the border of the field name at the top of the column. Then, click and drag to the right to show the rest of the file name 	(Empowerment Model.doc) as shown below.</p>
	

								<img class="img-wrap style1" src="images/computerbasics/FieldSized.jpg" width="699" height="518"/>	
...
<h4>Pop-Up Menu</h4>
								...
								<img class="img-wrap style1" src="images/computerbasics/popupmenu.png" width="699" height="518"/>
								<br />
								<br />
								
								<p>The pop-up menu in this example is notated in red.</p>	
								<p>This pop-up menu was opened when the user put the mouse pointer on the icon for the C: Drive (highlighted in blue) and then right clicked the mouse.</p>
