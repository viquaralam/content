				...
				<div class="row">
					...
					<div class="sectionContent">
						...
						<div class="row">
							...
							<p>There are a number of ways for you to see the storage space being used and what is still open and available. Since you have already used Computer or My Computer to access the Hard Drive or C: Drive on your computer, you will use this method again here. There are other ways to check free space and any method is acceptable.</p>
						...
						<ul class="nice tabs-content contained">
							<li class="active" id="nice1Tab">
								...
								<p>From your desktop, double click on the icon for Computer or My Computer.</p>
								<p>In the window that opens, right click on the C: drive and from the menu that appears, select Properties.</p>
														
								<img class="space" src="images/filesandfolders/driveproperties.jpg"/>
						<hr>							
							...
							<img class="space" src="images/filesandfolders/driveproperties2.jpg"/>
						...
						<hr>
							  ...
							  <li id="nice2Tab">
								<p>From your desktop, double click on the icon for Computer or My Computer and left click once on a storage drive such as the C: Drive. One place to view free space pops up as soon as you left click on the drive, at the bottom of the screen.</p>
								<img class="space" src="images/filesandfolders/drivespaceregularwindow.jpg"/>
							</li>
						</ul>								  
					<h4>Try It!</h4>
...
<div>	
				...
				<div class="row">
					<div class="twelve columns">	
						...
						<br>
					<div>	
						<video class="sublime" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="Determinehowmuchfreespaceisonastoragedevice" data-uid="def1f3df" preload="none">
							<source src="http://didljumpstart.com/video/fm/Determinehowmuchfreespaceisonastoragedevice.mp4" />
						</video>								
