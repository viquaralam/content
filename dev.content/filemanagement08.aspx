				...
				<div class="row">
					...
					<div class="sectionContent">
						...
						<div class="row">
							...
							<h4>Full Path Name for a File</h4>
...
<li>Make sure you understand the <strong>operation of the address bar</strong> so you can move from folder to folder in a path.</p>
							...
							<h4>Classic Windows, Windows Vista, and Windows 7 Folder Options - View Tab</h4>
														
								<img class="space" src="images/filesandfolders/folderoptionsviewtab2.jpg"/>
...
<img class="img-wrap style1" src="images/filesandfolders/addressbarwin7.jpg"/>
...
<img class="img-wrap style1" src="images/filesandfolders/addressbarwin72.jpg"/>
<hr>
...
<img class="img-wrap style1" src="images/filesandfolders/addressbarwin73.jpg"/>
<hr>
	...
	<div class="row">
					<div class="twelve columns">	
						...
						<br>
					<div>	
						<video class="sublime" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="Describingthefullpathnameforafilewin7" data-uid="def1f3df" preload="none">
...
<li id="nice2Tab">									<h4>Windows Vista</h4>
...
<img class="img-wrap style1" src="images/filesandfolders/addressbarvista.png"/>								
							<p>Remember that although all of the folders in the path are displayed in the address bar and title bar, the full path name includes the file name at the end. </p>
...
<img class="img-wrap style1" src="images/filesandfolders/addressbarvista2.jpg"/>

<hr>

<p>If you click on the folder icon in the left most portion of the address bar, it changes to almost the full path name. The only thing missing after you click on the folder icon in the address bar is file name. Notice that after you click on the folder icon, the navigation arrows disappear.</p>

<img class="img-wrap style1" src="images/filesandfolders/addressbarvista3.jpg"/>
<hr>
...
<div>	
						<video class="sublime" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="Describingthefullpathnameforafilevista" data-uid="def1f3df" preload="none">
...
<img class="img-wrap style1" src="images/filesandfolders/addressbarclassic.png"/>						
							<p>Remember that although all of the folders in the path are displayed in the address bar and title bar, the full path name includes the file name at the end. </p>
...
<div class="row">
					<div class="twelve columns">	
						...
						<br>
					<div>	
						<video class="sublime" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="Describingthefullpathnameforafileclassic" data-uid="def1f3df" preload="none">
