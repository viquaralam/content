					...
					<div class="sectionContent">
						...
						<div class="row">
							...
							<h4>Recycle Bin Icon</h4>
								...
								<img class="space" src="images/filesandfolders/recyclebinempty.jpg"/>
							<hr>
							<h4>Recycle Bin Empty Recycle Bin Full</h4>
							<img class="space" src="images/filesandfolders/recyclebinfull.jpg"/>
						...
						<p>In the example below, the user selected the folder called "test folder" by right clicking on it. The folder name is highlighted in blue.</p>
							...
							<h4>Deleting a File or Folder</h4>
								...
								<img class="space" src="images/filesandfolders/delete.jpg"/>
							
							<p>The user would then choose Delete from the pop-up menu.</p>
							<p>	When you choose delete, another pop-up menu appears on the screen to ask you again if you want to delete the file and send it to the recycle bin. </p>
							<p>	The computer is programmed to ask the user twice to make sure you really wish to delete that item and did not click on the file or folder by mistake.</p> 
							<p>	If you want to delete it, choose Yes. </p>
							<br /> 
							
								<img class="space" src="images/filesandfolders/deleteconfirm.jpg"/>
							...
							<p>When you empty the recycle bin, any items in the recycle bin are permanently deleted from the computer. To do this, you double click on the Recycle Bin icon on your desktop. From the pop-up menu you choose the Empty Recycle Bin option.</p>
...
<p>Select <strong>Empty the Recycle Bin</strong> from the toolbar. You must confirm the deletions.</p>
								...
								<img class="space" src="images/filesandfolders/win7recyclebin.jpg"/>
...
<p>Select <strong>Empty the Recycle Bin</strong> from the toolbar. You must confirm the deletions.</p>						
								<img class="space" src="images/filesandfolders/vistarecyclebin.jpg"/>
...
<p>Select <strong>File, Empty Recycle Bin</strong>. You must confirm the deletions.</p>							
								<img class="space" src="images/filesandfolders/classicrecyclebin.jpg"/>
						...
						<div class="row">
							<div class="twelve columns">	
								...
								<br>
							<div>	
								<video class="sublime" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="Deletingafileorfolde" data-uid="def1f3df" preload="none">
								  <source src="http://didljumpstart.com/video/fm/Deletingafileorfolder.mp4" />
								</video>
<hr>								
							</div>
