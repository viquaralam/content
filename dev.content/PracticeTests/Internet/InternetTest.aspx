<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="InternetTest.aspx.vb" Inherits="Practice_Internet_Test" title="Internet Practice Quiz" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 650px; height: 358px;" align="center" border="1" cellpadding="5">
        <tr>
            <td colspan="2" style="width: 876px; color: white;  vertical-align: middle; text-align: left; height: 32px;" class="pageHeader questionHeader">
