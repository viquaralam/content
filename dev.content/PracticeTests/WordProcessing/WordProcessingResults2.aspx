<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="WordProcessingResults2.aspx.vb" Inherits="Practice_WordProcessing_TestResults2" title="Word Processing Practice Quiz" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br /><br />
<table align="center">
        <tr>
            <td style="width: 650px; font-weight: normal; font-size: 12pt; vertical-align: middle; color: white; background-color: #00aeef; text-align: left;" class="pageHeader questionHeader"><h4> 
