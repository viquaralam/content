...
Imports System.Data
Partial Class Practice_FilesFolders_TestTest
    ...
    Shared QuestionArray(26) As Integer
    ...
    Public Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            If BindCt = 0 And SavQuestionId = NewQuestionId Then
                ...
                BindCt = 1
                Label4.Text = Label4.Text + " " + PagCnt.ToString + "-" + QuestionArray(PagCnt).ToString + " "
                PagCnt = PagCnt + 1
                If PagCnt >= 25 Then
                    ...
                    InitTime = 0
                    NewTitle = ""
                    Response.Redirect("FilesFoldersResult1.aspx")
                Else
    ...
    Protected Sub NextButton1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles NextButton1.Click
        ...
        If SavCt1 = 0 Then
            If SavCt = 0 Then
                ...
                al.Add(a)
                Session.Add("AnswerList", al)
                Label5.Text = Label5.Text + " " + PagCnt.ToString + "-" + QuestionArray(PagCnt).ToString + "-"
                ...
                Else
                    ...
                    For i As Integer = 0 To 25
                        If QuestionArray(i) = NewQuestionId Then
                            ...
                            userQuizDataSource.SelectCommand = "SELECT QuestionId, Title, Answer1, Answer2, Answer3, Answer4, Answer5, CorrectAnswer, AnswerExplanation, QuestionNo, Sections FROM Questions WHERE (Sections = 'Files and Folders') ORDER BY newid()"
                            questionDetails.DataBind()
                            dr = CType(questionDetails.DataItem, System.Data.DataRowView)
                    ...
                    QuestionArray(PagCnt) = NewQuestionId
                    Label6.Text = Label6.Text + " " + PagCnt.ToString + "-" + QuestionArray(PagCnt).ToString + "-"
                    PagCnt = PagCnt + 1
                End If
            End If
    End Sub
