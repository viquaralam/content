<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="FilesFoldersResults2.aspx.vb" Inherits="Practice_FilesFolders_TestResults2" title="Files & Folders Practice Quiz" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br /><br />
<table align="center" width="650px">
        <tr>
            <td style="vertical-align: middle; color: white; background-color: #00aeef; text-align: left;" class="pageHeader questionHeader"><h4> 
