<%@ Page Language="C#" MasterPageFile="AdminMasterPage.master" Title="Access Rule Summary" %>
...
<script runat="server">
	...
	private TreeNode AddNodeAndDescendents(string byUserOrRole, DirectoryInfo folder, TreeNode parentNode)
	{
		...
		node.ImageUrl = (action.Substring(0, 5) == "ALLOW") ? "~/images/greenlight.jpg" : "~/images/redlight.jpg";
...
<tr>
	<td class="details" valign="top" style="height: 248px">
		<table>
		<tr>
			<td valign="top" style="padding-right: 30px; height: 241px;">
