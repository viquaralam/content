<%@ Page Language="VB" MasterPageFile="~/MasterPage1.master" AutoEventWireup="false" CodeFile="InternetTest.aspx.vb" Inherits="TestingCenter_FinalTests_FinalTest" title="Internet Final Test" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server" />
        <asp:Timer ID="Timer1" runat="server" OnTick="Timer1_Tick " Interval="1000" />

    <table style="width: 650px; height: 358px;" align="center" border="1" cellpadding="5" class="container">
        <tr>
            <td colspan="2" style="width: 876px; color: white; background-color: #00aeef; vertical-align: middle; text-align: left" class="pageHeader questionHeader">
                <h2>Internet <br />Final Test</h2></td>
        </tr>
            <tr>
            <td style="width: 860px" rowspan="4">
                        ...
                        <asp:DetailsView ID="questionDetails" runat="server" 
                         AutoGenerateRows="False"
                            ...
                            Width="574px" EnableTheming="False" EnableViewState="False">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
                            ...
                            SelectCommand="SELECT QuestionId, Title, Answer1, Answer2, Answer3, Answer4, Answer5, CorrectAnswer, AnswerExplanation, QuestionNo, Sections FROM Questions WHERE (Sections = 'Internet') ORDER BY newid()">
                        </asp:SqlDataSource>
