<%@ Page Language="VB" MasterPageFile="~/MasterPage1.master" AutoEventWireup="false" CodeFile="ComputerBasicsTest.aspx.vb" Inherits="TestingCenter_ComputerBasics_FinalTest" title="Computer Basics Final Exam" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server" />
        <asp:Timer ID="Timer1" runat="server" OnTick="Timer1_Tick " Interval="1000" />

    <table style="width: 366px; height: 358px;" align="center" border="4" cellpadding="5" class="container">
        <tr>
            <td colspan="2" style="width: 876px; color: white; background-color: #00aeef; vertical-align: middle; text-align: left" class="pageHeader questionHeader">
                <h2>Computer Basics</h2> <h2>Final Exam</h2></td>
        </tr>
            <tr>
            <td style="width: 860px; font-size: 12pt;" rowspan="4">
                        ...
                        <asp:DetailsView ID="questionDetails" runat="server" 
                         AutoGenerateRows="False"
                            ...
                            Width="575px" EnableTheming="False" EnableViewState="False" 
                            Font-Size="14pt">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
                            ...
                            SelectCommand="SELECT QuestionId, Title, Answer1, Answer2, Answer3, Answer4, Answer5, CorrectAnswer, AnswerExplanation, QuestionNo, Sections FROM Questions WHERE (Sections = 'Computer Basics') ORDER BY newid()">
                                ...
                                <asp:RadioButtonList ID="AnswerRadioButtonList" runat="server"
                                    Width="424px" Height="38px" RepeatDirection="Horizontal" 
                  ...
                  <asp:Button ID="NextButton1" runat="server" Height="28px" Text="Next Question" 
