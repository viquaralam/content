    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Ptr = 0 Then
            ...
            If IsPostBack = False Then
                ...
                userQuizDataSource.InsertCommand = "INSERT INTO [UserQuiz] ([QuizID], [DateTimeComplete], [Score], [UserName], [Questions], [Correctans], [DateTaken], [Type], [Grade]) VALUES (@QuizID, @DateTimeComplete, @Score, @UserName, @Questions, @Correctans, @DateTaken, @Type, @Grade)"
                ...
                userQuizDataSource.InsertParameters.Add("Type", "Test")
