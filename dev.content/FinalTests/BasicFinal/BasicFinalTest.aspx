<%@ Page Language="VB" MasterPageFile="~/MasterPage1.master" AutoEventWireup="false" CodeFile="BasicFinalTest.aspx.vb" Inherits="TestingCenter_FinalTests_FinalTest" title="Final Exam" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 366px; height: 358px;" align="center" border="1" cellpadding="5">
        <tr>
            ...
            <tr>
            <td style="width: 860px" rowspan="3">
                
                        <asp:DetailsView ID="questionDetails" runat="server" 
                         AutoGenerateRows="False"
                            BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px"
                            CellPadding="4" DataKeyNames="QuestionId" DataSourceID="SqlDataSource1" Height="210px"
                            Width="576px" EnableTheming="False" EnableViewState="False">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
                            ...
                            SelectCommand="SELECT QuestionId, Title, Answer1, Answer2, Answer3, Answer4, Answer5, CorrectAnswer, AnswerExplanation, QuestionNo, Sections FROM Questions WHERE (Sections = 'Computer Basics') OR (Sections = 'Internet') OR (Sections = 'Word Processing') OR (Sections = 'SpreadSheets') OR (Sections = 'Files and Folders') ORDER BY newid()">
                        </asp:SqlDataSource>
                        
                                <asp:RadioButtonList ID="AnswerRadioButtonList" runat="server"
                                    Width="429px" Height="30px" RepeatDirection="Horizontal" 
                  ...
                  <asp:Button ID="NextButton1" runat="server" Height="22px" Text="Next Question" 
                            Width="402px" OnClick="NextButton1_Click" UseSubmitBehavior="False" 
                            CausesValidation="False" EnableViewState="False" Font-Size="12pt" />
                </td>
        </tr>
        ...
        <td style="vertical-align: top; text-align: left; height: 48px;">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Label ID="Label1" runat="server" Height="20px" Text="Beginning Time" 
        ...
        <tr style="height: 50px">
            ...
            <strong>End Date/Time:</strong><br />
              <asp:Label ID="Label2" runat="server" Height="20px" Text="End Time" Width="132px"></asp:Label>
              <br />
                <asp:Label ID="MesgLabel" runat="server" Height="24px" Text="Time has expired." 
                    Visible="False" Width="131px" style="font-weight: bold; color: red"></asp:Label>      
            </td>
        </tr>
