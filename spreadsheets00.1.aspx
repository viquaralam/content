...
<!-- Sticky Nav -->
			<ul id="navigationMenu">
			    ...
			    <li>
			    	<a class="stickyNext" href="spreadsheets01.aspx">&#8250;
			            <span>Next</span>
			        </a>
			    </li>
			    <li>
				     <a class="stickyPrev" href="spreadsheets00.aspx">&#8249;
			            <span>Previous</span>
			         </a>
			    </li>
			    <li id ="back-top">
...
<a href="spreadsheets00.1.aspx"class="active">Skills Mastery List</a>
</p>
					</div>
					...
					<div class="twelve columns">
						...
						<div class="row">
							<div class="twelve columns">
								...
								<hr>
								<p class="lead">Below are the required skills you must master <br />in order to complete the spreadsheets task:</p> 
								<div class="alert-box error">
									You must have access to spreadsheet software (Excel) for this section.
								...
								<table class="sortable">
									...
									<tbody>
										<tr>
											...
											<td>Using Font and Text Effects</td>
										</tr>
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td> Alignment in the Worksheet</td>
										</tr>
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
...
<tr>
										...
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Selecting Chart Data Range</td>
										</tr>
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Selecting Chart Options</td>
										</tr>
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Print Options</td>
										...
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Displaying Formulas on the Printout</td>
										</tr>										
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Fit to One Page</td>
										</tr>
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Printing Gridlines and Row/Column Headings on Every Page</td>
										</tr>	
									</tbody>
								</table>
								<br />
...
<ul class="disc">
<li> Selecting Chart Data Range</li>
<li> Selecting Chart Options</li>
<li> Displaying Formulas on the Printout</li>
<li> Printing Gridlines and Row/Column Headings on Every Page</li>
				...
				<div class="row centered">
					<div class="twelve columns">
						<div class="pageFooter">
							<span class="buttonRadius right"><a href="spreadsheets01.aspx" class="nice small radius green button">Continue&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i class="icon-arrow-right"></i></a></span>
							<span class="buttonRadius"><a href="spreadsheets00.aspx" class="nice small radius green button"><i class="icon-arrow-left"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Previous</a></span>
