        ...
        <tr>
            <td width="100%">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:jumpstartConnectionString %>"
                    ...
                    SelectCommand="SELECT Quiz.Title, UserQuiz.DateTaken, UserQuiz.Score FROM UserQuiz INNER JOIN Quiz ON UserQuiz.QuizId = Quiz.QuizId WHERE (UserQuiz.UserName = @UserName) AND (Quiz.Title = 'Practice Files and Folders Quiz') ORDER BY UserQuiz.DateTaken DESC">
                    <SelectParameters>
