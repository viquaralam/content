<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="FilesFoldersTest.aspx.vb" Inherits="Practice_FilesFolders_TestTest" title="DIDL Essential License Practice Files and Folders Test" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 650px; height: 358px;" align="center" border="1" cellpadding="5">
        <tr>
            <td colspan="2" style="width: 876px; color: white; background-color: #00aeef; font-weight: bold; vertical-align: middle; text-align: left;" class="pageHeader questionHeader">
                <h2>Files and Folders</h2><h2>Practice Quiz</h2></td>
        </tr>
            <tr>
            <td style="width: 860px" rowspan="4">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
                            ...
                            SelectCommand="SELECT QuestionId, Title, Answer1, Answer2, Answer3, Answer4, Answer5, CorrectAnswer, AnswerExplanation, QuestionNo, Sections FROM Questions WHERE (Sections = 'Files and Folders') ORDER BY newid()">
                        </asp:SqlDataSource>
                  ...
                  <asp:Button ID="NextButton1" runat="server" Height="22px" Text="Next Question" 
                            ...
                            CausesValidation="False" EnableViewState="False" Font-Bold="True" 
                            Font-Size="12pt" />
