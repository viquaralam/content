...
<!--! end of Section Header -->
				...
				<div class="row">
					...
					<div class="sectionContent">
						...
						<div class="row">
							<div class="twelve columns">
								<a name="content"></a><h4>Moving and Copying Files and Folders</h4>
								<hr>
								...
								<p>Don't forget, to get to drives, you use <strong>This PC</strong>, <strong>Computer</strong>, or <strong>My Computer</strong>.</p>
								...
								<img class="space" src="images/filesandfolders/cut.jpg" alt="">
								...
								<hr>
								<img class="space" src="images/filesandfolders/paste.jpg" alt="">
								...
								<img class="space" src="images/filesandfolders/copy.jpg" alt="">
						...
						<hr>
								...
								<p>It is a good idea to memorize the keyboard shortcuts for Copy, Cut, and Paste. These shortcuts can be used in many software programs such as <i>Microsoft Word</i> as well.</p>
								...
								<div>	
									...
									<div class="row">
										<div class="twelve columns">	
											...
											<br>
											<div>
											<video controls="controls" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-title="FF Moving or Copying" data-uid="Movingorcopyingafileorfolder" preload="none">
