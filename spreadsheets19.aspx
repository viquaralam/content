...
<dl class="nice contained tabs">
    <dd><a href="#nice1" class="active">Microsoft Excel 2007-20XX</a></dd>
...
<ul class="nice tabs-content contained">
    ...
    <li class="active" id="nice1Tab">
        ...
        <div class="row">
        <div class="twelve columns">
        <h4>Access to Print Options in Microsoft Word 2007-20XX</h4>

        <p> In Microsoft Excel 2007-20XX, you can access <strong>Print Options</strong> by clicking on the <strong>File Button</strong> and then on <strong>Print</strong>. In some versions, you then choose <strong>Print, Quick Print, or Print Preview</strong>, as shown below.</p>

        <img class="img-wrap style1" src="images/spreadsheets/ribbonprintoptions.jpg" alt="">
	<hr>
	
<p>In some versions, you get a <strong>Backstage view</strong> that shows the Print Preview, as shown below.</p>

<img class="img-wrap style1" src="images/spreadsheets/ribbonbackstageview.jpg" alt="">
        <p><strong>Print Preview</strong> brings up a view of how the spreadsheet will really print based on the current settings that are in place. If you do not like what you see and want to make changes, you can close the <strong>Print Preview</strong> and return to the spreadsheet to make the changes you want.</p><hr>
        </div>
        </div>
...
<img class="img-wrap style1" src="images/spreadsheets/classicprintoptions.jpg" alt="">
...
<dl class="nice contained tabs">
    <dd><a href="#nice3" class="active">Microsoft Excel 2007-20XX</a></dd>
...
<ul class="nice tabs-content contained">
    ...
    <li class="active" id="nice3Tab">
        ...
        <div class="row">
        <div class="twelve columns">
        <h4>Set Print Area in Microsoft Word 2007-20XX</h4>

        <p> In Microsoft Excel 2007-20XX, you can access Print Area by clicking on the <strong>Page Layout tab</strong> in the ribbon and in the <strong>Page Setup group</strong> you will see Print Area. Click on <strong>Print Area</strong> and there are two options: <strong>Set Print Area and Clear Print Area</strong>.
...
<p>As you would expect, click on Set Print Area to set and Clear Print Area to clear it. Note that once the Print Area is set in a spreadsheet, it will stay in place until the user clears it.</p>
        ...
        <img class="img-wrap style1" src="images/spreadsheets/ribbonsetprintarea.jpg" alt="">
<br />
<br />
...
<img class="img-wrap style1" src="images/spreadsheets/displayformula1.jpg" alt="">
<br>
<br>
...
<div class="twelve columns">	
								<h4>Displaying Formulas on the Printout (Excel 2007-20XX) </h4>
								<br>
								
<div>
									
			<video controls="controls" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-title="SS Printing Formulas" data-uid="printingformulas" preload="none">
...
<div>
			...
			<video controls="controls" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-title="SS Classic Printing Formulas" data-uid="printingformulasclassic" preload="none">
...
<dl class="nice contained tabs">
    <dd><a href="#nice5" class="active">Microsoft Excel 2007-20XX</a></dd>
...
<ul class="nice tabs-content contained">
    ...
    <li class="active" id="nice5Tab">
        ...
        <div class="row">
        <div class="twelve columns">
        <h4>Fit to One Page in Microsoft Excel 2007-20XX</h4>

        <p> In Microsoft Excel 2007-20XX, click on the <strong>Page Layout tab</strong> in the ribbon at the top of the document. Next, click on the <strong>arrow</strong> in the bottom right of the <strong>Page Setup group</strong>, the Page Setup Box opens up. </p>
 
        <div class="row">
							
<div class="twelve columns">	
								<h4>Fit to One Page (Excel 2007-20XX) </h4>
								<br>
								
<div>
									
			<video controls="controls" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-title="SS Fit to One Page" data-uid="fitotonepage" preload="none">
...
<div>
			...
			<video controls="controls" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-title="SS Classic Fit to One Page" data-uid="fitotonepageclassic" preload="none">
...
<img class="img-wrap style1" src="images/spreadsheets/pagesetupfittoonepage.jpg" alt="">
...
<img class="img-wrap style1" src="images/spreadsheets/pagesetupsheet.jpg" alt="">
<br>
<br>
...
<img class="img-wrap style1" src="images/spreadsheets/printpage1.jpg" alt="">
<img class="img-wrap style1" src="images/spreadsheets/printpage2.jpg" alt="">
<br>
<br>
...
<dl class="nice contained tabs">
    <dd><a href="#nice7" class="active">Microsoft Excel 2007-20XX</a></dd>
...
<ul class="nice tabs-content contained">
    ...
    <li class="active" id="nice7Tab">
        ...
        <div class="row">
        <div class="twelve columns">
        <h4>Printing Gridlines and Headers (Excel 2007-20XX)</h4>
 
      								<br>
								
<div>
									
			<video controls="controls" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-name="SS Gridlines and Headers" data-uid="printinggridlinesandheaders" preload="none">
						
<source src="http://didljumpstart.com/video/ss/printinggridlinesandheaders.mp4" />
						</video>								
...
<div>
			...
			<video controls="controls" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-title="SS Classic Gridlines and Headers" data-uid="printinggridlinesandheadersclassic" preload="none">
...
<img class="img-wrap style1" src="images/spreadsheets/pagesetupsheetrepeatcolumn.jpg" alt="">
<br>
<br>
...
<img class="img-wrap style1" src="images/spreadsheets/repeatcolumn.jpg" alt="">
<br>
<br>
...
<img class="img-wrap style1" src="images/spreadsheets/pagesetuprepeatcolumn.jpg" alt="">
<br>
<br>

<p>Notice that in page two of the printout, Column A is repeated and is next to Column L.</p>

<img class="img-wrap style1" src="images/spreadsheets/repeatcolumnpage2.jpg" alt="">
<br>
<br>
