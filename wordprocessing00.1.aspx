...
<!-- Sticky Nav -->
			<ul id="navigationMenu">
			    ...
			    <li>
			    	<a class="stickyNext" href="wordprocessing01.aspx">&#8250;
			            <span>Next</span>
			        </a>
			    </li>
			    <li>
...
<a href="wordprocessing00.1.aspx"class="active">Skills Mastery List
					...
					<div class="sectionContent">
						...
						<div class="row">
							<div class="twelve columns">
								...
								<p class="lead">Below are the required skills you must master in order to complete the Word Processing task:</p> 
								<div class="alert-box error">
									You must have access to word processing software (Word) for this section.
								...
								<table class="sortable">
									...
									<tbody>
										<tr>
											...
											<td>Setting Page Margins and Orientation</td>
										</tr>
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Justification/Alignment </td>
										</tr>
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Applying Fonts</td>
										</tr>
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
										...
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Inserting Manual Page Breaks</td>
										</tr>										
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
										...
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Date and/or Time Field</td>
										</tr>										
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Borders and Shading for Both Text and Paragraph</td>
										</tr>										
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Page Border and Border Art</td>
										</tr>										
										<tr>
											<td><label for="checkbox1"><input type="checkbox" id="checkbox1"></td>
											<td>Tables</td>
...
<ul class="disc">
<li> Paragraph Indention</li>
<li> Date and/or Time Field</li>
<li> Borders and Shading for Both Text and Paragraph</li>

<li> Page Border and Border Art</li>
</ul>
<br />
								...
								<p><strong>If you have checked all or most of the boxes above, you do not have to go through all of the tutorials for each skill.</strong></p>
				...
				<div class="row centered">
					<div class="twelve columns">
						<div class="pageFooter">
							<span class="buttonRadius right"><a href="wordprocessing01.aspx" class="nice small radius green button">Continue&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i class="icon-arrow-right"></i> </a></span>
							
							<span class="buttonRadius"><a href="wordprocessing00.aspx" class="nice small radius green button"><i class="icon-arrow-left"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Previous</a></span>
