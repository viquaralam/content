<%@ Page Title="" Language="VB" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="ProfileEditor3.aspx.vb" Inherits="admin_ProfileEditor3" %>
    ...
    <td>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="DIDLAccess" HeaderText="DIDL Access" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [UserId], [LastName], [FirstName], [CustomerId], [DIDLLevel], [TaskFM], [TaskWP], [TaskGraphics], [TaskDP], [TaskDB], [TaskSS], [TaskPP], [DateBasic], [DateProfessional], [DateMaster], [UserName], [TestProfessional], [TestBasic], [TestMaster], [TaskProfFinal], [TaskMasterFinal], [TestInternet], [DIDLAccess] FROM [Users]" 
