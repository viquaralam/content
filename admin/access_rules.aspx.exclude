...
<table class="webparts" style="width: 1244px">
<tr>
...
<tr>
	<td class="details" valign="top">
        <p>
            ...
            Rules are persisted as XML in each folder's Web.config file. <i>Page-level security
                and inner-page security are not handled using this tool &mdash; they are handled
                using specialized code that is available to the Web Developers.</i>
        </p>
		...
		<tr>
			...
			<asp:Panel runat="server" ID="SecurityInfoSection" Visible="false" Width="1012px">
				...
				OnRowDataBound="RowDataBound" Width="1001px"
				>
					<Columns>
				...
				<asp:RadioButton runat="server" ID="ApplyRole" GroupName="applyto"
					Text="This Role:" Checked="true" Width="92px" />
