...
<!-- Begin Drop Down Table of Contents Menu -->
				...
				<div class="row">
					...
					<div class="sectionContent">
						...
						<div class="row">
							<div class="twelve columns">
							    <a name="content"></a><h4>Drive, Directory, Folder and File</h4>
							    ...
							    There are other drives on your computer such as a CD drive, a DVD drive,
							        network drive or a USB drive. <span style="font-size:12.0pt;mso-bidi-font-size:11.0pt;
line-height:115%;font-family:&quot;Times New Roman&quot;,serif;mso-fareast-font-family:
Calibri;mso-fareast-theme-font:minor-latin;mso-bidi-theme-font:minor-bidi;
mso-ansi-language:EN-US;mso-fareast-language:EN-US;mso-bidi-language:AR-SA">You can also choose to save your data to the cloud (a storage location on the internet). </span>All computer drives after the hard drive or
						...
						<div class="row">
							<div class="twelve columns">
							    ...
							    In the left pane of the image below, you can see the root directory, the Acer (C:) drive, and the folders located in that directory.<br />
                                <br />
							    <img class="left space" src="images/computerbasics/CDriveRootDir.jpg" alt="">
							    <hr>
							
							    <p><b>Files</b> are created when you save your work with an application program. They are the individual documents (like Word documents, spreadsheets,
							    ...
							    or .xlsx are created using Microsoft Excel. <strong>It is important to remember,
							    you do not have to add the extension to the filename.</strong> The program you are
							    ...
							    when you double click a file with a particular file extension. The file extension is not normally shown, but you will learn how to show the file extension in the <i>Files and Folders</i> unit.</p>
    						<hr>
    					</div>
    				</div>
						...
						<div class="row">
							<div class="twelve columns">
								...
								<br />
							    <p>Before you begin working on the next unit, <I>Files and Folders</I>, it will
							    ...
							    Computer, Computer, or This PC.</p>
    						<hr>
    					</div>
    				</div>
						...
						<div class="row">
							<div class="twelve columns">
							    ...
							    also called My Computer or This PC. They mean the same thing, the name depends on the
							    version of Windows. <span style="font-size:12.0pt;line-height:115%;
...
EN-US;mso-bidi-language:AR-SA">If, for some reason, you do not see the icon, dont panic! You can right click on your desktop, choose <b style="mso-bidi-font-weight:
normal">Personalize </b>and <b style="mso-bidi-font-weight:normal">Change Desktop Icons</b>. From there you can check the box by the icon to show it on the desktop.</span></p>
							
							    <div class="three columns">
							        <img class="img-wrap style1" height="150" src=
							        "images/computerbasics/mycomputer.jpg" width="180" alt="">
							    ...
							    <div class="three columns">
							        <img class="img-wrap style1" height="150" src=
							        "images/computerbasics/mycomp.png" width="180" alt="">
							   ...
							   <div class="row">
							    ...
							    <p>In some versions of Windows, you can also reach Computer by clicking on the Start button. From the
							    pop-up menu, select Computer.</p>
							
							    <p>Below are two examples of what the computer directory you open may look like on the screen. See if you can locate the C: in each.</p>
    						<hr>
    					</div>
    				</div>
					...
					<div class="row">
							<div class="twelve columns">
							    ...
							    <br />
							    <img class="left space" src="images/computerbasics/CompDir1.jpg" alt="">
    						<hr>
    					</div>
    				</div>
					...
					<div class="row">
							<div class="twelve columns">
							    ...
							    <br />
							    <img class="left space" src="images/computerbasics/CompDir2.jpg" alt="">
    						<hr>
    					</div>
    				</div>
						...
						<div class="row">
							...
							<br />
							    <p>When you double click on the icon for the C: drive, you can view the
							        root directory which holds the files and folders saved and stored in it. Below is an
							    example of a C: Drive or root directory.</p>
							<hr>
							
							    <h4>Viewing the C: Drive Directory in Computer</h4><img class="left space"
							    src="images/computerbasics/CompDir3.jpg" alt="">
							    <br>
							    <br>
						...
						<div class="row">
							<div class="twelve columns">
							    ...
							    <br />
							    <div class="three columns">
							        <img class="img-wrap style1" src="images/computerbasics/wordicon.jpg" alt="">
							    ...
							    <div class="three columns">
							        <img class="img-wrap style1" src="images/computerbasics/excelicon.jpg" alt="">
							    ...
							    <div class="three columns">
							        ...
							        "images/computerbasics/acrobaticon.jpg" alt="">
...
<p>For more information on disgintuishing between a file or folder you can view the video demo for your version.</p>    					</div>
					...
					<div class="row">
						...
						<video controls="controls" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-title="CB Win 8 Files and Folders" data-uid="Distinguishingfilefolderwin8" preload="none">
						  <source src="http://didljumpstart.com/video/cb/distinguishingfilefolderwin8.mp4" />
						</video>								

									</li>
                                    <li id="nice2Tab">
						<video controls="controls" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-title="CB Win 7 Files and Folders" data-uid="Distinguishingbetweenafileandafolderwin7" preload="none">
						  <source src="http://didljumpstart.com/video/cb/Distinguishingbetweenafileandafolderwin7.mp4" />
						</video>								
									
									</li>
									<li id="nice3Tab">
						<video controls="controls" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-title="CB Vista Files and Folders" data-uid="Distinguishingbetweenafileandafoldervista" preload="none">
						  <source src="http://didljumpstart.com/video/cb/Distinguishingbetweenafileandafoldervista.mp4" />
						</video>								
									
									</li>
									<li id="nice4Tab">
						<video controls="controls" poster="http://didljumpstart.com/video/img/videocover478x360.jpg" width="480" height="360" data-title="CB Classic Files and Folders" data-uid="Distinguishingbetweenafileandafolderclassic" preload="none">
